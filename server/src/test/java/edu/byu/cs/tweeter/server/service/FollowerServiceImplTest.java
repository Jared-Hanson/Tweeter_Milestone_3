...
public class FollowerServiceImplTest {
    ...
    private FollowerServiceImpl followingServiceImplSpy;
    ...
    public void setup() {
        ...
        followingServiceImplSpy = Mockito.spy(FollowerServiceImpl.class);
    ...
    public void testGetFollowers_validRequest_correctResponse() throws IOException, TweeterRemoteException {
        FollowerResponse response = followingServiceImplSpy.getFollowers(request);
