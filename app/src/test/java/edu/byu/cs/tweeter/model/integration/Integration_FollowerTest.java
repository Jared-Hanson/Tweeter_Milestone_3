...
public class Integration_FollowerTest {
    ...
    private FollowerServiceProxy followingServiceSpy;
    ...
    public void setup() throws IOException, TweeterRemoteException {
        ...
        validRequest = new FollowerRequest(currentUser.getAlias(), 10, null);


        // Setup a mock ServerFacade that will return known responses
        successResponse = getFollowers(validRequest);



        // Create a FollowingService instance and wrap it with a spy that will use the mock service
        followingServiceSpy = Mockito.spy(new FollowerServiceProxy());

    }

    @Test
    public void testGetFollowerData_validRequest_correctResponse() throws IOException, TweeterRemoteException {
        FollowerResponse response = followingServiceSpy.getFollowers(validRequest);
